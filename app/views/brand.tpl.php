<section class="hero">
    <div class="container">
        ...
        <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active"><?= $currentBrand->getName(); ?></li>
        </ol>
        <!-- Hero Content-->
        <div class="hero-content pb-5 text-center">
            <h1 class="hero-heading"><?= $currentBrand->getName(); ?></h1>
            <!-- On vérifie si la methode getSubtitle existe car elle n'existe que dans les catégories -->
            <?php if(method_exists($currentBrand,'getSubtitle')):?>
            <div class="row">
                <div class="col-xl-8 offset-xl-2">
                    <p class="lead text-muted"><?= $currentBrand->getSubtitle() ?></p>
                </div>
            </div>
            <?php endif;?>
        </div>
