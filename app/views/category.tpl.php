<section class="hero">
    <div class="container">
        ...
        <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active"><?= $currentCategory->getName(); ?></li>
        </ol>
        <!-- Hero Content-->
        <div class="hero-content pb-5 text-center">
            <h1 class="hero-heading"><?= $currentCategory->getName(); ?></h1>
            <?php if(method_exists($currentCategory,'getSubtitle')):?>
            <div class="row">
                <div class="col-xl-8 offset-xl-2">
                    <p class="lead text-muted"><?= $currentCategory->getSubtitle() ?></p>
                </div>
            </div>
            <?php endif;?>
        </div>
        ...
        <div class="row">
            ...
            <?php foreach ($products as $key => $product) : ?>
                ...
                <div class="product col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="py-2">
                        <!-- On peut récupérer les types dans nos produits grace à la jointure de Product.php -->
